      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 rounded-lg bg-white/5 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-gray-800">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 mb-20">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-8 rounded-lg bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-gray-200 dark:border-gray-800">
              <div className="text-4xl font-bold text-blue-500 mb-2">500+</div>
              <div className="text-gray-600 dark:text-gray-400">DSA Problems</div>
            </div>
            <div className="p-8 rounded-lg bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-sm border border-gray-200 dark:border-gray-800">
            ...
            <div className="p-8 rounded-lg bg-gradient-to-br from-pink-500/10 to-blue-500/10 backdrop-blur-sm border border-gray-200 dark:border-gray-800">
